export const passwordMigrations = {
  ...
  migrations: {
    ...
    m0001:
      'CREATE INDEX `idx_passwords_category` ON `passwords` (`category`);--> statement-breakpoint\nCREATE INDEX `idx_passwords_favorite` ON `passwords` (`favorite`);',
    m0002: 'ALTER TABLE `passwords` ADD `totp_secret` text;',
  },
} as const;
