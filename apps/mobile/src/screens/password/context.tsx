...
import { create, type StoreApi, type UseBoundStore, useStore as useStore_ } from 'zustand'
import { immer } from 'zustand/middleware/immer'

export interface ModalDataAddPassword {
  type: 'add-password'
}
...
type ModalData = ModalDataAddPassword | ModalDataEditPassword | ModalDataDeletePassword
