...
- If you want to create complex component, take `docs/development/component.md` as reference
- If you want to create a modal like dialog or drawer and it's logic, take `docs/development/modal.md` as reference
- If you want to create a form, take `docs/development/form.md` as reference
